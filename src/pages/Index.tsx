        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
            ...
            delay: 0.2
              ...
              <img src="/lovable-uploads/d37d6696-8c7c-43b6-87f9-ca80fd121ac0.png" alt="Sesame AI App Screenshots" className="w-full rounded-2xl shadow-md" />
            </motion.div>
          </div>
          ...
          delay: 0.4
            ...
            <a href="https://apps.apple.com/us/app/sesame-ai-voice-companion/id6743081501" target="_blank" rel="noopener noreferrer">
              <Button variant="default" size="lg" className="bg-black text-white hover:bg-gray-800 transform hover:scale-105 transition-all">
                <Apple className="mr-2 h-5 w-5" />
                Download for iOS
              </Button>
            </a>
            <a href="https://play.google.com/store/apps/details?id=com.nextalk.app" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="lg" className="border-2 hover:bg-sesame-primary/10 transform hover:scale-105 transition-all">
